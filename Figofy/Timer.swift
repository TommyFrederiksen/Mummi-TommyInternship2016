...
public enum TimerProgressGlow {
    case Forward, Reverse, Constant, NoGlow
}

@IBDesignable
public class Timer: UIView {
    ...
    private var progressLayer: TimerProgressLayer! {
        get {
            return layer as! TimerProgressLayer
        }
    }
    ...
    @IBInspectable public var glowMode: TimerProgressGlow = .Forward {
        didSet {
    ...
    override public class func layerClass() -> AnyClass {
        return TimerProgressLayer.self
    }
    ...
    public func pauseAnimation() {
        guard let presentationLayer = progressLayer.presentationLayer() as? TimerProgressLayer else { return }
    ...
    private class TimerProgressLayer: CALayer {
        ...
        var glowMode: TimerProgressGlow!
        ...
        private struct GlowConstants {
            ...
            static func glowAmountForAngle(angle: Int, glowAmount: CGFloat, glowMode: TimerProgressGlow, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .Forward:
        ...
        override init(layer: AnyObject) {
            ...
            let progressLayer = layer as! TimerProgressLayer
